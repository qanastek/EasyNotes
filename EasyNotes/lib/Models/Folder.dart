...
class Folder extends Content with ChangeNotifier {
  ...
  String getDescription() {
    ...
    return "${this.notes.length} Elements";
  }
  ...
  void fillUp() {
    ...
    /// To-do's
    todoListSummer.checkboxes.add(CheckBox("Calanque de Sormiou, Marseille France",false));
    todoListSummer.checkboxes.add(CheckBox("Goa, India",false));
    todoListSummer.checkboxes.add(CheckBox("Helsinki, Finland",true));
    todoListSummer.checkboxes.add(CheckBox("Wacken, Germany",false));
    ...
    todoListSummer.checkboxes.add(CheckBox("Iceland",false));
    todoListSummer.checkboxes.add(CheckBox("Seoul, South Korea and Tokyo, Japan",false));
    todoListSummer.checkboxes.add(CheckBox("Sri Lanka",true));
    todoListSummer.checkboxes.add(CheckBox("Paris, France",true));
    todoListSummer.checkboxes.add(CheckBox("Dubai, UAE",false));

    folderSummer.add(todoListSummer);
